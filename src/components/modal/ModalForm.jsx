    ...
    <>
      ...
      <ModalContainer isOpen={isOpen}>
        <ModalContent>
          ...
          <button className='signupformbtn' onClick={onClose} style={{ position: 'absolute', top: '6.9rem', right: '7.1rem' ,width: '14rem', height:'5.3rem',  gap:'1rem', justifyContent:'center', alignItems:'center', background:'#6BA6FF' , color: 'white'}}>
            신청하기
          </button>
          <TutorThumbnail>
