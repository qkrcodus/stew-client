    ...
    <>
      ...
      <ModalContainer $isOpen={isOpen}>
        <ModalContent>
          ...
          <TutorThumbnail>
            {console.log("Image URL: ", applicationDetail.tutor_img)}
            <TutorImg $imageUrl={applicationDetail.tutor_img} />
            <div>
              <div>{applicationDetail.tutor_name} 튜터 / {applicationDetail.sport_name}
                <Space />
          ...
          <Purpose>
            <h3>운동 목적</h3>
            <textarea value={applicationDetail.purpose} readOnly />
          </Purpose>
          <IntensityPreference>
            <h3>운동 선호 강도</h3>
            <textarea value={applicationDetail.intensity} readOnly />
          </IntensityPreference>
          <MessageToTutor>
            <h3>튜터에게 전할 말</h3>
